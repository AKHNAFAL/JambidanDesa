<div class="relative grid grid-cols-1 gap-2 p-4 mb-4 mt-4 border rounded-lg bg-white shadow-lg">
    <div class="relative flex gap-4">
        ...
        <div class="flex flex-col w-full">
            <div class="flex flex-row justify-between">
                <p class="relative text-xl whitespace-nowrap truncate overflow-hidden">Pengomentar</p>
